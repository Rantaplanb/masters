...
Place identity records, certificates, transcripts, and application exports here.

This directory is excluded from Git by the archive `.gitignore`.
Keep a separate encrypted backup and do not share these files through the repository.
...
- `loukas-mertzanis-bsc-transcript.pdf`
- `loukas-mertzanis-passport-photo.jpg`
- `loukas-mertzanis-bsc-thesis.pdf`
- `loukas-mertzanis-cv.pdf`
- `application-submission.pdf`
- `application-fee-receipt.pdf`
